...
tr_name = []
vl_name = []
with open('/media/lisa/UNI/ML/training_set_Rosetta/dataset/list15051.txt', 'r') as text:
    count = 0
...
with open('/home/lisa/Desktop/ML/training_set.csv', 'w') as ts:
...
with open('/home/lisa/Desktop/ML/validation_set.csv', 'w') as vs:
